...
const BookCard = ({ title, author, status, children }) => {
 ...
 duration-300 hover:border-2 hover:border-blue-500 border border-gray-700'>
            ...
            {/* Status */}
            <span className={`text-sm font-medium px-4 py-1 rounded-full tracking-wide shadow-sm ${StatusColors[status] || 'bg-gray-600'} text-white`}>{status}</span>
